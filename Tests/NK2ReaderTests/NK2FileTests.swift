...
final class NK2FileTests: XCTestCase {
    func testSimple() throws {
        do {
            ...
            XCTAssertEqual(UUID(uuidString: "FE42AA0A-18C7-1A10-E885-0B651C240000"), (file.rows[0].entryId as? ContactAddressEntryID)!.providerUid)
            ...
            XCTAssertEqual(UUID(uuidString: "7C318F3F-FCF3-834F-B657-337775D8BDBE"), ((file.rows[0].entryId as? ContactAddressEntryID)!.entryIdBytes as? GeneralEntryID)!.providerUid)
            XCTAssertEqual([0xA4, 0x00, 0x20, 0x00, 0x75, 0xD8, 0xBD], ((file.rows[0].entryId as? ContactAddressEntryID)!.entryIdBytes as? GeneralEntryID)!.providerData)
            ...
            XCTAssertEqual(UUID(uuidString: "FE42AA0A-18C7-1A10-E885-0B651C240000"), (file.rows[0].recipientEntryId as? ContactAddressEntryID)!.providerUid)
            ...
            XCTAssertEqual(UUID(uuidString: "7C318F3F-FCF3-834F-B657-337775D8BDBE"), ((file.rows[0].recipientEntryId as? ContactAddressEntryID)!.entryIdBytes as? GeneralEntryID)!.providerUid)
            XCTAssertEqual([0xA4, 0x00, 0x20, 0x00, 0x75, 0xD8, 0xBD], ((file.rows[0].recipientEntryId as? ContactAddressEntryID)!.entryIdBytes as? GeneralEntryID)!.providerData)
        }
    }
    ...
    func testRecent() throws {
        do {
            ...
            XCTAssertEqual(UUID(uuidString: "812B1FA4-BEA3-1019-9D6E-00DD010F5402"), (file.rows[0].recipientEntryId as? OneOffEntryID)!.providerUid)
            ...
            XCTAssertEqual(UUID(uuidString: "812B1FA4-BEA3-1019-9D6E-00DD010F5402"), (file.rows[0].entryId as? OneOffEntryID)!.providerUid)
            ...
            XCTAssertEqual(UUID(uuidString: "812B1FA4-BEA3-1019-9D6E-00DD010F5402"), (file.rows[1].recipientEntryId as? OneOffEntryID)!.providerUid)
            ...
            XCTAssertEqual(UUID(uuidString: "812B1FA4-BEA3-1019-9D6E-00DD010F5402"), (file.rows[1].entryId as? OneOffEntryID)!.providerUid)
        ...
        do {
            ...
            XCTAssertEqual("hughbellars@gmail.com", file.rows[0].nickName)
            XCTAssertEqual(0x00000000, file.rows[0].recipientResourceState)
            XCTAssertEqual([UUID(uuidString: "00000000-0000-0000-0000-000000000000")], file.rows[0].abProviders!)
            ...
            XCTAssertEqual(UUID(uuidString: "DCA740C8-C042-101A-B4B9-08002B2FE182"), (file.rows[1].entryId as? AddressBookEntryID)!.providerUid)
            ...
            XCTAssertEqual("/o=First Organization/ou=Exchange Administrative Group(FYDIBOHF23SPDLT)/cn=Recipients/cn=00037FFE34534C30\u{00}", (file.rows[1].entryId as? AddressBookEntryID)!.x500DN)
            XCTAssertEqual([UUID(uuidString: "00000000-0000-0000-0000-000000000000")], file.rows[1].abProviders!)
            XCTAssertEqual(.mailUser, file.rows[1].displayType!)
            XCTAssertEqual(0x00000000, (file.rows[1].recipientEntryId as? AddressBookEntryID)!.flags)
            XCTAssertEqual(UUID(uuidString: "DCA740C8-C042-101A-B4B9-08002B2FE182"), (file.rows[1].recipientEntryId as? AddressBookEntryID)!.providerUid)
            ...
            XCTAssertEqual("/o=First Organization/ou=Exchange Administrative Group(FYDIBOHF23SPDLT)/cn=Recipients/cn=00037FFE34534C30\u{00}", (file.rows[1].recipientEntryId as? AddressBookEntryID)!.x500DN)
            ...
            XCTAssertEqual(UUID(uuidString: "812B1FA4-BEA3-1019-9D6E-00DD010F5402"), (file.rows[2].entryId as? OneOffEntryID)!.providerUid)
            ...
            XCTAssertEqual(UUID(uuidString: "812B1FA4-BEA3-1019-9D6E-00DD010F5402"), (file.rows[2].recipientEntryId as? OneOffEntryID)!.providerUid)
    ...
    func testJoachimmetzPlaso() throws {
        do {
            ...
            XCTAssertEqual(UUID(uuidString: "812B1FA4-BEA3-1019-9D6E-00DD010F5402"), (file.rows[3].entryId as? OneOffEntryID)!.providerUid)
            ...
            XCTAssertEqual(UUID(uuidString: "812B1FA4-BEA3-1019-9D6E-00DD010F5402"), (file.rows[3].recipientEntryId as? OneOffEntryID)!.providerUid)
            ...
            XCTAssertEqual(UUID(uuidString: "812B1FA4-BEA3-1019-9D6E-00DD010F5402"), (file.rows[4].entryId as? OneOffEntryID)!.providerUid)
            ...
            XCTAssertEqual(UUID(uuidString: "812B1FA4-BEA3-1019-9D6E-00DD010F5402"), (file.rows[4].recipientEntryId as? OneOffEntryID)!.providerUid)
